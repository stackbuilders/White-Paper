...
We have working prototype with the basic functionality of the GET Economy DApp, it is written in Haskell and it uses the Plutus Playground. It is described in detail in Appendix A.
...
\begin{figure}[h]
  \centering{
    \large
    \resizebox{\textwidth}{!}{\input{diagrams/arch.tex}}
  }
